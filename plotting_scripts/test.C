...
void generate_1Dplot(vector<TH1F*> hist, char const *tag_name="", float energy=-1, int xmax=-1,int xmin=-1,char const *leg_head="",
  ...
  legend = new TLegend(0.5,0.5,0.79,0.9);  
...
void test(string pathname)
{
  ...
  vector<string> f;
  f = {"Summer20UL18_TTJets.root", "Summer20UL18_TTGJets_Tune.root", "Summer20UL18_WJetsToLNu_HT.root", "Summer20UL18_WGJets_MonoPhoton.root", "Summer20UL18_ZJetsToNuNu_HT.root", "Summer20UL18_ZNuNuGJets_MonoPhoton.root", "Summer20UL18_QCD_HT.root","Summer20UL18_GJets_DR-0p4_HT.root"};
  ...
  for (int bigi=0; bigi<bigbaseline.size(); bigi++)
	...
	{ TFile *root_file = new TFile(f[i_file].c_str()); 
	  ...
	  xtitle = {diff_title[bigi], diff_title[bigi], diff_title[bigi], diff_title[bigi], diff_title[bigi], diff_title[bigi], diff_title[bigi], diff_title[bigi],diff_title[bigi],diff_title[bigi],diff_title[bigi]};
