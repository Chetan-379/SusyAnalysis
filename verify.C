void verify()
{
  ...
  char filename1[1000], filename2[1000], filename3[1000], filename4[1000], filename5[1000], filename6[1000];
    ...
    //   sprintf(filename2,"/eos/home-c/cagrawal/SusySoftPhoAna/FR_estimation/Alpana_FR_root_files/Summer20UL%s_TTJets_PhoIdloose_phopt40_MET200.root", years[iyear].c_str());
    //   //}
